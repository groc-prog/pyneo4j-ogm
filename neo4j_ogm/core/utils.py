...
def ensure_hydration(func: Callable):
    """
    Decorator which ensures that a instance has been hydrated before running any queries.

    Raises:
        InstanceNotHydrated: Raised if the method is called on a instance which has not been hydrated
    """
...
def ensure_alive(func: Callable):
    """
    Decorator which ensures that a instance has not been destroyed before running any queries.
